...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::create(['username'=>'rodrigo01','name'=>'Rodrigo','apellido'=>'Zelaya','email'=>'rodrigo@gmail.com','password'=>'12345','puesto_id'=>'3'])->assignRole('Administrador')->rutas()->attach([1,2,3,4,5,6,8]);
